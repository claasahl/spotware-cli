...
describe("Structure Points", () => {
  ...
  test("upward ladder", () => {
    ...
    const points = structurePoints([barA, barB, barC, barD, barE, barF]);
    expect(points).toStrictEqual([
      { timestamp: 100, direction: "down", value: 85, trendbar: barA },
      { timestamp: 300, direction: "up", value: 120, trendbar: barC },
      { timestamp: 400, direction: "down", value: 95, trendbar: barD },
      { timestamp: 600, direction: "up", value: 130, trendbar: barF },
    ]);
  });
});
