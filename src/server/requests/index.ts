...
import { request as PROTO_OA_ASSET_LIST_REQ } from "./PROTO_OA_ASSET_LIST_REQ";
...
import { request as PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_REQ } from "./PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_REQ";
...
import { request as PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQ } from "./PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQ";
...
export function requests(socket: SpotwareSocket) {
  const requests = [
    ...
    PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQ(socket),
